 ...
 * the dashboard talks to the cloud API (chat-recall.hotmun.com) instead of the
 ...
 *
 *   VITE_OIDC_ISSUER     e.g. https://auth.hotmun.com/realms/hotmun
 *   VITE_OIDC_CLIENT_ID  default: chat-recall-web
 *   VITE_API_BASE        e.g. https://chat-recall.hotmun.com/api
 */
