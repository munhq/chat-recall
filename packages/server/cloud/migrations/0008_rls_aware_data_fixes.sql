...
--   0007  written to consolidate project ids after the munhq → munhq rename.
...
-- ── 0007's work: consolidate ids orphaned by the munhq → munhq org rename ──
...
--
-- Scope is narrow on purpose: only git:github.com/munhq/* → munhq/*, verified
-- against the working tree where every affected repo's origin now points at
-- munhq/<same-name>. acme-corp, darkkraft, maintainer and third-party clones are
