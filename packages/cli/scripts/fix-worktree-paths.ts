 ...
 *   /home/user/claude/pr/bot/worktrees/inco/infrastructure/393
 * that don't exist on disk, because the real cwd had dashes inside
 * folder names (`.claude-pr-bot`, `inco-infrastructure-393`).
 *
...
import { resolveProjectId, resetProjectResolverCache } from '@chat-recall/engine/core/project-resolver.js';
