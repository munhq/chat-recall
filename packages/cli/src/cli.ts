...
const DEFAULT_ALLOW = [
  ...
  'recall_tasks', 'recall_task_create', 'recall_task_update', 'recall_task_comment', 'recall_task_policy',
  'recall_help',
  ...
  'recall_user_prompts', 'recall_decision_record', 'recall_decisions', 'recall_decision_scan',
  'recall_analytics_summary',
